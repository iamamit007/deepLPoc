...
PATH_TO_LABELS = 'annotations/labelmap.pbtxt'#download_labels(LABEL_FILENAME)
...
for image_path in IMAGE_PATHS:
    ...
    print(np.size(detections['detection_boxes']))
    print(np.size(detections['detection_classes']))
    print(np.size(detections['detection_scores']))
    print(detections['detection_scores'])
    print(np.size(detections['num_detections']))
